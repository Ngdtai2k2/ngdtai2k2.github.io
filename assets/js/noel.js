...
class World {
  ...
  addSpiral() {
    ...
    const colorChoices = ["pink", "green", "cyan", "wheat", "red", "blue", "purple", "white", "yellow", "gray", "silver" , "orange" , "aquamarine"];
  ...
  addIcosa({ color = "white", scale, position = [0, 0, 0] }) {
    ...
    icosa.scale.set(...scale);
    icosa.position.set(...position);
    this.icosa.add(icosa);
  }
  addOctahedrons() {
  ...
  addIcosahedrons() {
    this.icosa = new THREE.Group();
    this.icosaGeometry = new THREE.IcosahedronGeometry(0.1, 2);
    this.addIcosa({ color: "#f2ef99", scale: [2, 2, 2] });
